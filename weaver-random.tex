...
comparações. No entanto, isso não é recomendado para uso em
projetos.
...
\subsecao{2.5. Estrutura Final do Arquivo}
...
pelo \monoespaco{arc2random} fornecido pelo sistema. A sequência de
...
Em seguida, como sugerido por [Knuth, 1998], usamos o teste
...
gerador de números aleatórios da biblioteca padrão, \monoespaco{rand}:
...
&&\monoespaco{rand}&&91\%&&67\%&&0\%&\cr\linha
...
!defined(W_RNG_PCG) && !defined(W_RNG_ISO_C)
#ifdef __SIZEOF_INT128__
